...
import com.example.isk.ThreadActivityAdmin;
import com.example.isk.api.Thread;

import java.util.ArrayList;

public class AdapterThreadAdmin extends RecyclerView.Adapter<AdapterThreadAdmin.HolderThread> {

    ArrayList<Thread> listThread;

    public AdapterThreadAdmin(ArrayList<Thread> listThread) {
    ...
    public void onBindViewHolder(@NonNull HolderThread holder, int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), ThreadActivityAdmin.class);
